...
jobs:
  comment:
    ...
    timeout-minutes: 10
    steps:
      # Pin the review-focused renderer; never use the triggering PR's ref.
      ...
      - name: Install himorime and its comment helper
        run: go install github.com/nao1215/himorime@8cc393f17a9b9a246b8918df0476f0ec97033778 github.com/nao1215/himorime/cmd/himorime-comment@8cc393f17a9b9a246b8918df0476f0ec97033778
