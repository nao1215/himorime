...
// RemoveAll removes a directory tree, retrying briefly. On Windows a file a
// just-terminated process had open stays locked for a moment after the
// process is gone, and removing it fails with a sharing violation.
