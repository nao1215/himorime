...
func TestRenderCommentEscapesHostileNamesAndIsBounded(t *testing.T) {
	...
	for _, want := range []string{"<!-- himorime:benchmark-report:v2 run_id=9001 workflow_id=44 run_number=12 run_attempt=2 -->", "Performance regression", "&#64;org/team", "<details>", "suite\\|&lt;script&gt;", "— failure", "<sub>Generated by [himorime](https://github.com/nao1215/himorime)</sub>"} {
